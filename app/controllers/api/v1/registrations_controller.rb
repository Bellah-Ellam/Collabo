...
class Api::V1::RegistrationsController < ApplicationController
    ...
    def create
      ...
      if @user.save
        render json: { success: "User registered successfully" }, status: :created
          else
    ...
    private
    # def user_params
    #   params.permit(:name, :username, :email, :bio, :photo, :doB, :password, :password_confirmation)
    # end

    # def user_params
    #   params.require(:user).permit(:name, :username, :email, :bio, :photo, :doB, :password, :password_confirmation)
    # end

    def user_params
      params.require(:registration).permit(:name, :username, :email, :bio, :photo, :doB, :password)
    end
